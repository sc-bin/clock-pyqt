...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(1690, 920, 221, 81))
        self.horizontalLayoutWidget_3.setObjectName("horizontalLayoutWidget_3")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_3)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.label_STR4 = QtWidgets.QLabel(self.horizontalLayoutWidget_3)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(253, 26, 204))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        brush = QtGui.QBrush(QtGui.QColor(253, 26, 204))
        brush.setStyle(QtCore.Qt.SolidPattern)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.WindowText, brush)
        self.label_STR4.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("Segoe UI Emoji")
        font.setPointSize(27)
        self.label_STR4.setFont(font)
        self.label_STR4.setStyleSheet("")
        self.label_STR4.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.label_STR4.setAlignment(QtCore.Qt.AlignCenter)
        self.label_STR4.setObjectName("label_STR4")
        self.horizontalLayout_2.addWidget(self.label_STR4)
        self.label_up_fans = QtWidgets.QLabel(self.horizontalLayoutWidget_3)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(230, 31, 150))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        brush = QtGui.QBrush(QtGui.QColor(230, 31, 150))
        brush.setStyle(QtCore.Qt.SolidPattern)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.WindowText, brush)
        self.label_up_fans.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("Segoe UI Emoji")
        font.setPointSize(27)
        self.label_up_fans.setFont(font)
        self.label_up_fans.setStyleSheet("")
        self.label_up_fans.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.label_up_fans.setAlignment(QtCore.Qt.AlignCenter)
        self.label_up_fans.setObjectName("label_up_fans")
        self.horizontalLayout_2.addWidget(self.label_up_fans)
        self.horizontalLayoutWidget_4 = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget_4.setGeometry(QtCore.QRect(810, 690, 481, 311))
        ...
        self.calendarWidget.setGeometry(QtCore.QRect(1310, 680, 601, 221))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 180, 126))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Light, brush)
        brush = QtGui.QBrush(QtGui.QColor(228, 255, 155))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Base, brush)
        brush = QtGui.QBrush(QtGui.QColor(255, 180, 126))
        brush.setStyle(QtCore.Qt.SolidPattern)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_STR4.setText(_translate("MainWindow", "粉丝:"))
        self.label_up_fans.setText(_translate("MainWindow", "000"))
